...
define('SECRET_SALT','v=BUzAqARDx3gX0UkIHZf7l3=udiM88x');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','oscaralejandrofloresyllescas34@gmail.com');
...
define('DBNAME','ticketsistema');
define('DBUSER','admin');
define('DBPASS','NFRmtc/*');
